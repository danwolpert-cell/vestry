    ...
    <div style={{ minHeight:"100vh", background:C.bg, fontFamily:"'Inter', system-ui, sans-serif", color:C.text }}>
      ...
      <div style={{ borderBottom:`1px solid ${C.border}`, padding:"0 28px", display:"flex", alignItems:"center", justifyContent:"space-between", height:56 }}>
        <div style={{ display:"flex", alignItems:"center", gap:28 }}>
          ...
          {["portfolio","hedgefunds","watchlist","analytics","advisor"].map(t => (
            <button key={t} onClick={()=>setTab(t)} style={{ background:"none", border:"none", color:tab===t?C.text:C.sub, fontWeight:tab===t?700:400, fontSize:14, cursor:"pointer", padding:"0 4px", textTransform:"capitalize" }}>{t==="advisor"?"AI Advisor":t==="hedgefunds"?"Hedge Funds":t==="watchlist"?"Watchlist":t==="analytics"?"Analytics":"Portfolio"}</button>
          ))}
        </div>
        <div style={{ display:"flex", gap:10 }}>
      ...
      <div style={{ maxWidth:1140, margin:"0 auto", padding:"28px 24px" }}>
        ...
        {tab === "analytics" && <Analytics holdings={portfolio} />}
        {tab === "advisor" && (
